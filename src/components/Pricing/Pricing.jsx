...
const Pricing = () => {
  return (
    <section class="text-gray-600 body-font overflow-hidden bg-[#303030]">
  <div class="container px-5 py-24 mx-auto">
    ...
    <div class="flex flex-wrap justify-around items-center -m-4">
      <div class="p-4 xl:w-1/4 md:w-1/2 w-full bg-[#e8631c]">
        <div class="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
          <h2 class="text-sm tracking-widest title-font mb-1 font-medium text-white">START</h2>
          <h1 class="text-5xl  pb-4 mb-4 border-b border-gray-200 leading-none text-white">Free</h1>
          ...
          <p class="text-xs text-gray-500 mt-3 text-white">Literally you probably haven't heard of them jean shorts.</p>
        </div>
      </div>
      <div class="p-4 xl:w-1/4 md:w-1/2 w-full bg-[#e8631c]">
        <div class="h-full p-6 rounded-lg border-2 border-indigo-500 flex flex-col relative overflow-hidden">
          ...
          <p class="text-xs  mt-3 text-white">Literally you probably haven't heard of them jean shorts.</p>
        </div>
      </div>
      <div class="p-4 xl:w-1/4 md:w-1/2 w-full bg-[#e8631c]">
        <div class="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
